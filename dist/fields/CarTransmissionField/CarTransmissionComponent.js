...
exports.CarTransmissionComponent = void 0;
var React = __importStar(require("react"));
var forms_1 = require("payload/components/forms");
var config_1 = require("../../config");
var CarTransmissionComponent = function (_a) {
    var path = _a.path;
    ...
    React.useEffect(function () {
        var allCarType = config_1.Car_Transmission === null || config_1.Car_Transmission === void 0 ? void 0 : config_1.Car_Transmission.map(function (type) {
            return {
                label: type.value,
                value: type.name,
            };
    ...
    return (React.createElement("div", null,
        React.createElement("label", { className: "field-label" }, "\u8B8A\u901F\u7CFB\u7D71 (Car Transmission)"),
...
exports.CarTransmissionComponent = CarTransmissionComponent;
