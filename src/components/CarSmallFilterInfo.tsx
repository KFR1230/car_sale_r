...
const CarSmallFilterInfo = ({ product }: { product: Product }) => {
  const {
    isDeposit,
    Car_Brand,
    Car_Name,
        ...
        {isDeposit && (
          <div className="absolute bottom-6 right-3 z-30" aria-hidden={true}>
            <Image
              ...
              height="32"
              priority
              sizes="(max-width:768px) 700px,(min-width:768px) and (max-width:1024px) 70vw,(min-width:1024px) 100vw"
            />
          </div>
        )}
          ...
          <div className="relative">
            <div className="flex justify-between items-center">
              <div className="flex flex-col items-center">
                <p
                  className={cn(
                    'text-2xl font-extrabold  tracking-wider line-clamp-1',
                ...
                {is_onSale ? (
                  <p className="text-xl font-semibold tracking-wider line-clamp-1">
                    ${formatPrice(onSale)}
                  </p>
                ) : (
                  <p
...
export default CarSmallFilterInfo;
